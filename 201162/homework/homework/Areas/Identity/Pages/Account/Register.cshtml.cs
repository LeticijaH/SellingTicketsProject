...
namespace homework.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new CinemaUser { Name = Input.Name, Surname = Input.Surname, Address = Input.Address,
                    UserName = Input.Email, Email = Input.Email, UserShoppingCart = new ShoppingCart() };
